...
public class ThreeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Float r1 = spGlycemies.getFloat("GlycAp2", 0);
        if (r1 != null)
            t = String.valueOf(r1);
        t4.setText(t);

        Float r2 = spGlycemies.getFloat("unitInject2", 0);
        if (r2 != null) {
            t2.setText(String.valueOf(r2));
        }
        Float r3 = spGlycemies.getFloat("glucoAvantRepas2", 0);
        if (r3 != null)
            t1.setText(String.valueOf(r3));

        Float r4 = spGlycemies.getFloat("confirmDose2", 0);
        if (r4 != null)
            t3.setText(String.valueOf(r4));

        String r5 = spGlycemies.getString("comment3", "");
        t5.setText(r5);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (t.trim().equals("")) {
                    ...
                    edit.putFloat("GlycAp2", GlycAp);
                    edit.apply();

                    edit.putString("comment3",t5.getText().toString());
                    edit.apply();
                }
            }
        });
